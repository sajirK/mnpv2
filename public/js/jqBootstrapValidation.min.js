        ...
        init: function(e) {
          ...
          return a(s).bind("submit", function(e) {
            ...
            o.trigger("submit.validation").trigger("validationLostFocus.validation"), o.each(function(e, t) {
              var i = a(t).parents(".control-group").first();
              i.hasClass("warning") && (i.removeClass("warning").addClass("error"), n++)
            ...
            var e = a(this),
              ...
              d = [];
            if (!l.length && t.options.autoAdd && t.options.autoAdd.helpBlocks && (l = a('<div class="help-block" />'), n.find(".controls").append(l), i.push(l[0])), t.options.sniffHtml) {
              var c = "";
              if (void 0 !== e.attr("pattern") && (c = "Not in the expected format\x3c!-- data-validation-pattern-message to override --\x3e", e.data("validationPatternMessage") && (c = e.data("validationPatternMessage")), e.data("validationPatternMessage", c), e.data("validationPatternRegex", e.attr("pattern"))), void 0 !== e.attr("max") || void 0 !== e.attr("aria-valuemax")) {
                ...
                c = "Too high: Maximum of '" + v + "'\x3c!-- data-validation-max-message to override --\x3e", e.data("validationMaxMessage") && (c = e.data("validationMaxMessage")), e.data("validationMaxMessage", c), e.data("validationMaxMax", v)
              }
              if (void 0 !== e.attr("min") || void 0 !== e.attr("aria-valuemin")) {
                var u = void 0 !== e.attr("min") ? e.attr("min") : e.attr("aria-valuemin");
                c = "Too low: Minimum of '" + u + "'\x3c!-- data-validation-min-message to override --\x3e", e.data("validationMinMessage") && (c = e.data("validationMinMessage")), e.data("validationMinMessage", c), e.data("validationMinMin", u)
              }
            ...
            a.each(d, function(i, n) {
              ...
              if (r = r || "'" + n + "' validation failed \x3c!-- Add attribute 'data-validation-" + n.toLowerCase() + "-message' to input to change this message --\x3e", a.each(t.validatorTypes, function(t, i) {
                  void 0 === h[t] && (h[t] = []), s || void 0 === e.data("validation" + n + o(i.name)) || (h[t].push(a.extend(!0, {
                    name: o(i.name),
                    message: r
                  }, i.init(e, n))), s = !0)
